...
export class ProjectUpdateComponent implements OnInit {
	...
	member_para: string = 'After selection of villages with the help of District unit of SRLM, members will be mobilized. The typical member profile will be focussed on small and marginal women farmers, but to keep Business interest in mind, membership may be offered to mid- size and large farmers also. For mobilization of farmers, initial awareness program and training regarding Farmer Producer Company and regarding procurement will be conducted and membership will be offered to those, who are interested to be members. Mobilization cum training material will be prepared by FDRVC and training program will be conducted with the help of District Mission Management Unit of SRLM. Membership will be opened for 6 months in the initial phase, but from second year onwards, it will be opened for certain time-period every year.';
